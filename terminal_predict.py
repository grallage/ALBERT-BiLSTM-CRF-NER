...
# 根据自行情况修改该路径
model_dir = r'/content/albert_base_ner_checkpoints'
bert_dir = '/content/albert_base'
...
with graph.as_default():
    ...
    bert_config = modeling.AlbertConfig.from_json_file(os.path.join(bert_dir, 'albert_config.json'))
...
tokenizer = tokenization.FullTokenizer(
        vocab_file=os.path.join(bert_dir, 'vocab_chinese.txt'), do_lower_case=do_lower_case)
